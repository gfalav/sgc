...
class ClientesControllerTest < ActionController::TestCase
  ...
  test "should create cliente" do
    assert_difference('Cliente.count') do
      post :create, cliente: { apellido: @cliente.apellido, ciiu_id: @cliente.ciiu_id, contacto: @cliente.contacto, direccion_id: @cliente.direccion_id, documento: @cliente.documento, email: @cliente.email, iibb: @cliente.iibb, nombres: @cliente.nombres, tcliente_id: @cliente.tcliente_id, tdoc_id: @cliente.tdoc_id, telefono: @cliente.telefono, tiibb: @cliente.tiibb, weblog: @cliente.weblog }
    end
