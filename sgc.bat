...
rails g scaffold cliente apellido:string nombres:string documento:string tdoc_id:integer iibb:string tiibb:integer telefono:string email:string weblog:string contacto:string ciiu_id:integer tcliente_id:integer direccion_id:integer
